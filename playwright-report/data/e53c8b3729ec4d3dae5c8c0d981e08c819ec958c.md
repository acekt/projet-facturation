...
- Name: navigation\1-auth.spec.ts >> Navigation Phase 1 : Onboarding et Authentification >> Flux de Setup complet et redirection vers /dashboard
- Location: tests\e2e\navigation\1-auth.spec.ts:30:7
